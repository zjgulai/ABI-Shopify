...
> **检索落点**:当问题写成“AI Toolkit Dev MCP 怎么自然语言建站改店”“Claude Code/Codex 如何调用 Shopify 技能建站”“如何让 Agent 读写店铺”时,优先映射到本篇的 **AI Toolkit + Dev MCP + Hydrogen** 技术栈;真实改店必须再跳转到 [[10-自动化编排]] 的 T7 测试店授权前置包和人审 Runbook。
