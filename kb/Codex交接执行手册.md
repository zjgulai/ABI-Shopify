...
> 当前事实层:整套知识库+产品已落地,CodeGraph 已初始化,腾讯云站点已上线到 `platform.shopify.lute-tlz-dddd.top`。T1/T2/T3/T5 已有本地或生产证据;T4 基础生产化代码已落地但 bge-m3/Chroma/Neo4j 尚未在生产启用;T6/T7 仍是后续任务,其中 T7 必须测试店与人审授权。
